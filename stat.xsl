...
<xsl:template match="worker">
    <tr bgcolor="#666666"><td colspan="12"/></tr>
    <tr bgcolor="#aaaaaa">
        <td colspan="2"><b>Worker #<xsl:value-of select="n"/></b>, pid <xsl:value-of select="pid"/></td>
...
<xsl:template match="stream">
        ...
        <td>
            <a href="">
                <xsl:attribute name="onclick">
                    var d=document.getElementById('<xsl:value-of select="../../../../n"/>-<xsl:value-of select="../../name"/>-<xsl:value-of select="name"/>');
    ...
    <tr style="display:none">
        <xsl:attribute name="id">
            <xsl:value-of select="../../../../n"/>-<xsl:value-of select="../../name"/>-<xsl:value-of select="name"/>
        </xsl:attribute>
